...
int main()
{
  ...
  char my_char3 = 'z';
  my_char3 = my_char3 + 1; //the value is no longer alphabetic becuase it has reached its max end
...
//my_short2 became a negative vaiue because adding one to the integer completely
// changed its value making it a negative
